...
{
  /**
   * Constante para log para erros
   * @var ERROR
   **/     
  const ERROR = 1;

  /**
   * Constante para log para alertas
   * @var WARN
   **/
  const WARN  = 2;

  /**
   * Constante para log para informacoes
   * @var INFO
   **/
  const INFO  = 3;

  /**
   * Constante para log para debugs
   * @var DEBUG
   **/
  const DEBUG = 4;

  /**
   * Diretorio onde ficarao os arquivos de log
   * @var dir
   **/
  protected $dir;
  ...
  /**
   * Extensao do arquivo de log
   * @var extensionFile
   **/
  protected $extensionFile;    

  /**
   * Permissao do arquivo de log
   * @var permissionFile
   **/
